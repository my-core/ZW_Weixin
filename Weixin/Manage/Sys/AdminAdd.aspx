<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAdd.aspx.cs" Inherits="Weixin.Web.Manage.Admin.AdminAdd" %>
...
<body>
    ...
    <div>
        <table class="infotable" >
            ...
            <tr>
                <td class="tr">姓名：</td>
                <td><asp:TextBox ID="txtAdminName" runat="server" CssClass="easyui-validatebox txt" data-options="required:true" missingmessage="请输入姓名"></asp:TextBox></td>
            </tr>
            <tr>
                <td class="tr">禁用：</td>
