...
namespace Weixin.Web.Manage.Admin
{
    public partial class GroupAdd : AdminPage
    {
        ...
        public void BindInfo()
        {
            if (_ID == 0)
                return;
            DataTable dt = sysService.GetDataByKey("T_Group", "ID", _ID);
        ...
        public void GetActionJson()
        {
            ...
            DataTable dtGroupAction = sysService.GetDataByKey("T_ActionGroup", "GroupID", _ID);
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count == 0)
                dt.Rows.Add(dr);
            int res = sysService.SaveGroup(dt, GetAction());
            if (res > 0)
