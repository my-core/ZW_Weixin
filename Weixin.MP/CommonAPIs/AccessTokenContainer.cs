...
namespace Weixin.MP.CommonAPIs
{
    ...
    public class AccessTokenContainer
    {
        ...
        /// <returns></returns>
        public static string TryGetToken(string appId, string appSecret, bool getNewToken)
        {
            if (!CheckRegistered(appId) || getNewToken)
            {
                Register(appId, appSecret);
            }
            return GetToken(appId,false);
        }
        ...
        /// <returns></returns>
        public static string GetToken(string appId, bool getNewToken )
        {
        ...
        /// <param name="getNewToken">是否强制重新获取新的Token</param>
        /// <returns></returns>
        public static AccessTokenResult GetTokenResult(string appId, bool getNewToken )
        {
