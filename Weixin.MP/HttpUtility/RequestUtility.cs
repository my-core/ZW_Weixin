...
namespace Weixin.MP.HttpUtility
{
    public static class RequestUtility
    {
        ...
        /// <returns></returns>
        public static string HttpGet(string url, CookieContainer cookieContainer , Encoding encoding )
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer, Dictionary<string, string> formData, Encoding encoding )
        {
        ...
        /// <returns></returns>
        public static string HttpPost(string url, CookieContainer cookieContainer , Stream postStream , Dictionary<string, string> fileDictionary , string refererUrl , Encoding encoding)
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";
