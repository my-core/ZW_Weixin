...
namespace Weixin.MP.HttpUtility
{
    public static class Post
    {
        ...
        /// <returns></returns>
        public static T PostFileGetJson<T>(string url, CookieContainer cookieContainer , Dictionary<string, string> fileDictionary , Encoding encoding )
        {
        ...
        /// <returns></returns>
        public static T PostGetJson<T>(string url, CookieContainer cookieContainer , Stream fileStream , Encoding encoding )
        {
        ...
        public static T PostGetJson<T>(string url, CookieContainer cookieContainer , Dictionary<string, string> formData , Encoding encoding )
        {
