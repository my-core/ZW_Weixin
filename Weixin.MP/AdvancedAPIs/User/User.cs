...
namespace Weixin.MP.AdvancedAPIs
{
    ...
    public static class User
    {
        ...
        /// <returns></returns>
        public static UserInfoJson Info(string accessToken, string openId, Language lang)
        {
            if (lang == null)
            {
                lang = Language.zh_CN;
            ...
            return HttpUtility.Get.GetJson<UserInfoJson>(url,null);
        ...
        public static OpenIdResultJson Get(string accessToken, string nextOpenId)
        {
            ...
            return HttpUtility.Get.GetJson<OpenIdResultJson>(url, null);
        }
    }
}
