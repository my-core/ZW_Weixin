...
namespace Weixin.MP.AdvancedAPIs
{
    ...
    public static class Groups
    {
        ...
        public static CreateGroupResult Create(string accessToken, string name)
        {
            ...
            return CommonJsonSend.Send<CreateGroupResult>(accessToken, urlFormat, data,CommonJsonSendType.POST);
        }
        ...
        public static GroupsJson Get(string accessToken)
        {
            ...
            return HttpUtility.Get.GetJson<GroupsJson>(url,null);
        }
        ...
        public static GetGroupIdResult GetId(string accessToken, string openId)
        {
            ...
            return CommonJsonSend.Send<GetGroupIdResult>(accessToken, urlFormat, data,CommonJsonSendType.POST);
        }
        ...
        public static WxJsonResult Update(string accessToken, int id, string name)
        {
            ...
            return CommonJsonSend.Send(accessToken, urlFormat, data,CommonJsonSendType.POST);
        }
