...
namespace Weixin.MP.AdvancedAPIs
{
    ...
    public static class OAuth
    {
        ...
        /// <returns></returns>
        public static string GetAuthorizeUrl(string appId, string redirectUrl, string state, OAuthScope scope, string responseType )
        {
            if(responseType=="")
            {
                responseType="code";
        ...
        /// <param name="grantType"></param>
        /// <returns></returns>
        public static OAuthAccessTokenResult RefreshToken(string appId, string refreshToken, string grantType )
        {
            if (grantType == "")
            {
